...
export const DIALOG_CONTENT = {
  ...
  'multi-model': {
    ...
    subtitle: 'Choose your model — with automatic fallback behind it',
    body: 'Richie isn\'t locked to a single AI. In chat you pick the model you prefer — Auto, Gemini, Mistral, DeepSeek, Llama, or premium GPT-5.3 and Claude 4.5 on Pro — and an automatic fallback keeps a grounded answer coming even if one provider is busy. On Pro and Ultra, the AI Council goes further: several expert perspectives reason over your data in parallel and Richie reconciles them into one takeaway you can inspect.',
    highlights: [
      'A model picker in every chat — you\'re in control',
      'Resilient by design: automatic failover, no dead ends',
      'AI Council (Pro/Ultra): multiple perspectives, reconciled into one answer',
      'Every answer grounded in your own health record',
      'Continuously evaluated so quality improves over time',
    ],
    footer: 'Most health apps give you one opinion. RichHealth gives you a panel — and shows you the reasoning behind the answer.',
  },
  'doctor-triangle': {
    title: 'The Doctor–Patient–AI Triangle',
    subtitle: 'AI that prepares you for care — with a clinician in the loop',
    body: 'Richie doesn\'t pretend to be your doctor. It organises and explains your health so a real consultation starts from your whole story, not a blank page. Connect a doctor through the Doctor Portal and share exactly what you choose — history, medications, reports, alerts — so their judgement is applied to complete information.',
    highlights: [
      'Richie analyses and explains your data instantly',
      'You control precisely what a connected doctor can see',
      'Your doctor starts from a complete, organised picture',
      'Richie helps you prepare and understand — never diagnoses',
    ],
    footer: 'Speed of AI, judgement of medicine. Richie brings the first; your clinician brings the second.',
  },
  'environmental': {
    title: 'Environmental Health Intelligence',
    subtitle: 'The air you breathe is part of your health record',
    body: 'India loses an estimated 1.5 million lives a year to air pollution. RichHealth treats your environment as a health variable: Richie tracks your location\'s AQI, builds a long-term exposure profile, and factors pollution into today\'s advice — powered by open air-quality data (OpenAQ) so it works street by street.',
    highlights: [
      'Real-time AQI using US & China standards',
      'PM2.5, PM10, O₃ with health-impact context',
      'Exposure factored into your daily advisory',
      'Long-term environmental exposure profile',
      'Location-based health news and outbreak awareness',
    ],
    footer: 'In a country where air quality affects hundreds of millions, treating it as a health signal isn\'t a feature — it\'s a category.',
  },
  ...
  'period-tracker': {
    ...
    highlights: [
      ...
      'Private by default. Encrypted in transit and at rest. Never used for advertising.',
  ...
  'council-ai': {
    title: 'AI Council — A Panel of Perspectives',
    subtitle: 'Several expert lenses. One reconciled answer. Pro & Ultra.',
    body: 'On the Pro and Ultra tiers, important questions aren\'t answered once. Richie convenes a council — distinct expert perspectives (a cardiometabolic lens, a behavioural-and-adherence lens, a holistic lifestyle lens) each reason over your data in parallel, then Richie reconciles them into a single grounded takeaway. You see both the individual takes and the synthesis — a second, third and fourth opinion on your own health data.',
    highlights: [
      'Multiple expert perspectives reason in parallel',
      'Disagreements are surfaced, not hidden — you see divergence',
      'Reconciled final answer grounded in your actual health data',
      'Especially powerful for report interpretation and risk questions',
      'Premium models and automatic fallback keep it resilient',
    ],
    footer: 'You wouldn\'t settle a complex diagnosis with a single opinion. Richie doesn\'t either.',
  },
  'genetics-engine': {
  ...
  'mental-health': {
    title: 'What You Tell Richie Stays Yours',
    subtitle: 'You control Richie\'s memory and what improves the model',
    body: 'Your conversations with Richie are private by default. Two switches in the app put you in charge: turn Richie\'s memory on or off, and decide whether your data helps improve the model — off means off. Nothing you share is mined for advertising or sold, and sensitive topics are treated with care.',
    highlights: [
      'Memory is a toggle — clear it or turn it off anytime',
      'Opt out of model improvement with one switch',
      'No advertising network, no behavioural profiling',
      'Your data is never sold — full stop',
      'Culturally aware, judgment-free by design',
    ],
    footer: 'Privacy isn\'t a mode you switch into. It\'s the default, with the controls in your hands.',
  },
  'data-control': {
    title: 'Your Data, Your Rules',
    subtitle: 'Real control over your health information',
    body: 'Data control at RichHealth isn\'t just a settings page — it\'s a philosophy. You decide what Richie can reference, what your family and doctors can see, and how long anything lives.',
    highlights: [
      'Close your account and wipe your personal identifiers in one tap',
      'Request a full export or complete erasure — we honour it',
      'Granular family sharing — choose what each member sees',
      'Selective AI access — decide what Richie can reference',
      'Per-record controls on every symptom, report and medication',
    ],
  ...
  'pricing-plus': {
    ...
    footer: '20% launch discount included. Cancel anytime — your data stays yours.',
  },
  'pricing-pro': {
    title: 'RichHealth Pro — Family Health Intelligence',
    subtitle: '₹2,499 for 3 months · ₹833/month equivalent · Most popular',
    body: 'Pro unlocks the features families actually need: the AI Council (multiple expert perspectives, reconciled), premium models like GPT-5.3 and Claude 4.5, more dependents, weekly check-ins, and direct connections with doctors on the platform. This is the plan most Indian families settle on.',
    highlights: [
      'Everything in Plus',
      'AI Council — multiple perspectives, reconciled into one answer',
  ...
  'pricing-ultra': {
    ...
    body: 'Ultra is for families who treat health intelligence as the most important investment they make. A full year of unlimited AI analyses, one subscription covering up to five family members, newborn growth and vaccine tracking, and white-glove onboarding.',
    highlights: [
      'Everything in Pro',
      ...
      'Up to 5 dependents and 5 family members — Pro shared across the family',
      'Priority Doctor Portal sharing',
      'Health check-ins every 3 days',
      'Newborn growth percentiles & immunisation calendar',
...
export const RICHIE_PROMPTS = [
  {
    ...
    answer: 'I analyse your medical reports, turn your Apple Watch vitals into meaning, track symptoms, medications and periods, monitor how air quality affects you, manage health for your dependents (from newborns to elders), and connect your family\'s history for hereditary insights. On Pro and Ultra, I answer with a council — several expert perspectives I reconcile into one grounded takeaway. The more you share, the smarter I get about YOUR family, specifically.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Upload any medical report — CBC, lipid panel, thyroid, HbA1c, hormone panel — and I\'ll extract key findings, flag abnormal values, and cross-reference them against your full health profile, your medications, your cycle (if applicable) and your family\'s hereditary conditions — and I track every value over time so you see the trend, not just today\'s number.',
  },
  {
